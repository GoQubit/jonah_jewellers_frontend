...
export function InvestmentStatsCards({ sellerWallerInfo }: { sellerWallerInfo: any }) {
  const stats = [
    {
      ...
      value: `${sellerWallerInfo?.investedAmount | 0 }`,
      icon: RiWallet3Line,
    ...
    },
    {
      ...
      value: `${sellerWallerInfo?.availableToWithdraw | 0}`,
    ...
    },
    {
      ...
      value: `${sellerWallerInfo?.profitOnJewelry | 0}`,
      icon: GiTakeMyMoney,
      bgColor: "bg-blue-500",
      textColor: "text-white",
    },
    {
      ...
      value: `${sellerWallerInfo?.currentGoldInvestment | 0}`,
      icon: FaArrowTrendUp,
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 my-8">

...
const AddToCartToast = ({ show, onClose, customButtonId }: { show: boolean, onClose: Function, customButtonId?: string }) => {
  ...
  return (
    <div className={`z-[9999999] fixed top-4 left-1/2 transform -translate-x-1/2 p-4 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 ${show ? 'translate-y-[20px] opacity-100' : 'translate-y-[-75px]'} px-4 py-3 flex gap-4 w-[360px] items-center`}>
